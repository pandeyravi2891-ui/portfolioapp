...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg("Network error or server unreachable. Please try again later.");
    } finally {
      setLoading(false);
    }
  };
